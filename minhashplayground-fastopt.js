...
function $s_Lscalatags_generic_InputAttrs$class__multiple__Lscalatags_generic_InputAttrs__Lscalatags_generic_AttrPair($$this) {
  var this$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr($$this, "multiple", null, false);
...
function $s_sc_IterableLike$class__grouped__sc_IterableLike__I__sc_Iterator($$this, size) {
  var this$1 = $$this.iterator__sc_Iterator();
  var this$2 = new $c_sc_Iterator$GroupedIterator().init___sc_Iterator__sc_Iterator__I__I(this$1, this$1, size, size);
...
/** @constructor */
function $c_Lwebpage_Minhash$() {
  $c_O.call(this)
}
$c_Lwebpage_Minhash$.prototype = new $h_O();
$c_Lwebpage_Minhash$.prototype.constructor = $c_Lwebpage_Minhash$;
/** @constructor */
function $h_Lwebpage_Minhash$() {
  /*<skip>*/
}
$h_Lwebpage_Minhash$.prototype = $c_Lwebpage_Minhash$.prototype;
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$renderBands$1__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLDivElement = (function(seeds$1, box1$1, box2$1, mhNum$1, bandNum$1, tokenizer$1) {
  var x = $as_T(bandNum$1.value);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var this$4 = $m_jl_Integer$();
  var $$this = this$2.repr$1;
  var b = this$4.parseInt__T__I__I($$this, 10);
  var x$1 = $as_T(mhNum$1.value);
  var this$6 = new $c_sci_StringOps().init___T(x$1);
  var this$8 = $m_jl_Integer$();
  var $$this$1 = this$6.repr$1;
  var h = this$8.parseInt__T__I__I($$this$1, 10);
  var minhashes = this.generateMinhashes$1__p1__T__T__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_List($as_T(box1$1.value), $as_T(box2$1.value), seeds$1, mhNum$1, tokenizer$1);
  var f = (function(x$2$2) {
    var x$2 = $as_T3(x$2$2);
    return $uJ(x$2.$$und1$1)
  });
  var this$9 = $m_sci_List$();
  var bf = this$9.ReusableCBFInstance$2;
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((minhashes === $m_sci_Nil$())) {
      var jsx$1 = $m_sci_Nil$()
    } else {
      var arg1 = minhashes.head__O();
      var h$1 = new $c_sci_$colon$colon().init___O__sci_List(f(arg1), $m_sci_Nil$());
      var t = h$1;
      var rest = $as_sci_List(minhashes.tail__O());
    ...
    var b$1 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(minhashes, bf);
    var these = minhashes;
    while ((!these.isEmpty__Z())) {
  ...
  var minA = $as_sci_List(jsx$1);
  var f$1 = (function(x$3$2) {
    var x$3 = $as_T3(x$3$2);
    return $uJ(x$3.$$und2$1)
  });
  ...
  if ((bf$1 === $m_sci_List$().ReusableCBFInstance$2)) {
    ...
    var b$2 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(minhashes, bf$1);
    var these$1 = minhashes;
    while ((!these$1.isEmpty__Z())) {
      var arg1$5 = these$1.head__O();
      b$2.$$plus$eq__O__scm_Builder(f$1(arg1$5));
      these$1 = $as_sci_List(these$1.tail__O())
    };
    var jsx$2 = b$2.result__O()
  };
  var minB = $as_sci_List(jsx$2);
  var size = ((h / b) | 0);
  var this$11 = $s_sc_IterableLike$class__grouped__sc_IterableLike__I__sc_Iterator(minA, size);
  var f$2 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$1) {
    var x$4 = $as_sci_List(x$2$1);
    return $m_s_util_hashing_MurmurHash3$().seqHash__sc_Seq__I(x$4)
  }));
  var bandsA = new $c_sc_Iterator$$anon$11().init___sc_Iterator__F1(this$11, f$2);
  var size$1 = ((h / b) | 0);
  var this$12 = $s_sc_IterableLike$class__grouped__sc_IterableLike__I__sc_Iterator(minB, size$1);
  var f$3 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$2$3) {
    var x$5 = $as_sci_List(x$2$3);
    return $m_s_util_hashing_MurmurHash3$().seqHash__sc_Seq__I(x$5)
  }));
  var bandsB = new $c_sc_Iterator$$anon$11().init___sc_Iterator__F1(this$12, f$3);
  var this$13 = new $c_sc_Iterator$$anon$19().init___sc_Iterator__sc_Iterator(bandsA, bandsB);
  var this$14 = $m_sci_List$();
  var cbf = this$14.ReusableCBFInstance$2;
  var bands = $as_sci_List($s_sc_TraversableOnce$class__to__sc_TraversableOnce__scg_CanBuildFrom__O(this$13, cbf));
  var elem$1 = 0;
  elem$1 = 0;
  var these$2 = bands;
  while ((!these$2.isEmpty__Z())) {
    var arg1$6 = these$2.head__O();
    var x$6 = $as_T2(arg1$6);
    if (($uI(x$6.$$und1$f) === $uI(x$6.$$und2$f))) {
      elem$1 = ((1 + elem$1) | 0)
    };
    these$2 = $as_sci_List(these$2.tail__O())
  };
  var numTrue = elem$1;
  var jsx$29 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$28 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$27 = $m_Lscalatags_JsDom$all$().fontSize__Lscalatags_generic_Styles$fontSize$().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("12px", $m_Lscalatags_JsDom$all$().stringStyle$1);
  var jsx$26 = ((numTrue > 0) ? $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h6__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Its a 'match'!"))])) : $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h6__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Its not a 'match'!"))])));
  var jsx$25 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag());
  $m_Lscalatags_JsDom$all$();
  var v = ((("There were " + numTrue) + " matching bands out of ") + b);
  var jsx$24 = jsx$25.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v)]));
  var jsx$23 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dl__Lscalatags_generic_TypedTag());
  var jsx$22 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$21 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dt__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Band Collision Rate: "))]))]));
  var jsx$20 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dd__Lscalatags_generic_TypedTag());
  var jsx$19 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-8", $m_Lscalatags_JsDom$all$().stringAttr$1);
  $m_Lscalatags_JsDom$all$();
  var v$1 = (numTrue / b);
  var v$2 = ("" + v$1);
  var jsx$18 = jsx$23.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$22, jsx$21, jsx$20.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$19, new $c_Lscalatags_JsDom$StringFrag().init___T(v$2)]))]));
  var this$31 = $m_Lscalatags_JsDom$all$();
  var f$4 = (function(x$2$4) {
    var x$7 = $as_T2(x$2$4);
    if (($uI(x$7.$$und1$f) === $uI(x$7.$$und2$f))) {
      var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$8 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
      var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$6 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm bg-success text-white", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var v$3 = $uI(x$7.$$und1$f);
      var v$4 = ("" + v$3);
      var jsx$5 = jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6, new $c_Lscalatags_JsDom$StringFrag().init___T(v$4)]));
      var jsx$4 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$3 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm bg-success text-white", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var v$5 = $uI(x$7.$$und2$f);
      var v$6 = ("" + v$5);
      return jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, jsx$5, jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, new $c_Lscalatags_JsDom$StringFrag().init___T(v$6)]))]))
    } else {
      var jsx$16 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$15 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
      var jsx$14 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$13 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var v$7 = $uI(x$7.$$und1$f);
      var v$8 = ("" + v$7);
      var jsx$12 = jsx$14.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$13, new $c_Lscalatags_JsDom$StringFrag().init___T(v$8)]));
      var jsx$11 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$10 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var v$9 = $uI(x$7.$$und2$f);
      var v$10 = ("" + v$9);
      return jsx$16.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$15, jsx$12, jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$10, new $c_Lscalatags_JsDom$StringFrag().init___T(v$10)]))]))
    }
  });
  var this$30 = $m_sci_List$();
  var bf$2 = this$30.ReusableCBFInstance$2;
  if ((bf$2 === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((bands === $m_sci_Nil$())) {
      var jsx$17 = $m_sci_Nil$()
    } else {
      var arg1$7 = bands.head__O();
      var h$3 = new $c_sci_$colon$colon().init___O__sci_List(f$4(arg1$7), $m_sci_Nil$());
      var t$2 = h$3;
      var rest$2 = $as_sci_List(bands.tail__O());
      while ((rest$2 !== $m_sci_Nil$())) {
        var arg1$8 = rest$2.head__O();
        var nx$2 = new $c_sci_$colon$colon().init___O__sci_List(f$4(arg1$8), $m_sci_Nil$());
        t$2.tl$5 = nx$2;
        t$2 = nx$2;
    ...
    var b$3 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(bands, bf$2);
    var these$3 = bands;
    while ((!these$3.isEmpty__Z())) {
      var arg1$9 = these$3.head__O();
      b$3.$$plus$eq__O__scm_Builder(f$4(arg1$9));
      these$3 = $as_sci_List(these$3.tail__O())
    };
    var jsx$17 = b$3.result__O()
  };
  var xs = $as_sc_Seq(jsx$17);
  var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
  return jsx$29.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$28, jsx$27, jsx$26, jsx$24, jsx$18, new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$31, xs, ev)])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lwebpage_Minhash$.prototype.init___ = (function() {
  return this
});
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$renderBandOptions$1__Lorg_scalajs_dom_raw_HTMLInputElement__sci_List = (function(mhNum$1) {
  var x = $as_T(mhNum$1.value);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var this$4 = $m_jl_Integer$();
  var $$this = this$2.repr$1;
  var i = this$4.parseInt__T__I__I($$this, 10);
  var x$1 = $uD($g.Math.sqrt(i));
  var j = $doubleToInt($uD($g.Math.ceil(x$1)));
  var this$14 = new $c_sci_Range().init___I__I__I(1, j, 1);
  var p = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(i$1) {
    return (function(n$2) {
      var n = $uI(n$2);
      return (((i$1 % n) | 0) === 0)
    })
  })(i));
  var l = $as_sci_IndexedSeq(new $c_sc_TraversableLike$WithFilter().init___sc_TraversableLike__F1(this$14, p).map__F1__scg_CanBuildFrom__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(i$1$1) {
    return (function(n$2$1) {
      var n$1 = $uI(n$2$1);
      $m_sci_List$();
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([n$1, ((i$1$1 / n$1) | 0)]);
  ...
  })(i)), ($m_sci_IndexedSeq$(), $m_sc_IndexedSeq$().ReusableCBF$6)));
  var this$18 = $m_sci_List$();
  var cbf$1 = this$18.ReusableCBFInstance$2;
  var this$19 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(l, cbf$1));
  $m_sci_List$();
  var b = new $c_scm_ListBuffer().init___();
  var these = this$19;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var xs$1 = $as_sc_GenTraversableOnce(arg1).seq__sc_TraversableOnce();
    b.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs$1);
    these = $as_sci_List(these.tail__O())
  };
  var this$21 = b.toList__sci_List();
  var this$22 = $as_sc_SeqLike($s_sc_SeqLike$class__distinct__sc_SeqLike__O(this$21));
  var ord = $m_s_math_Ordering$Int$();
  var divisors = $as_sci_List($s_sc_SeqLike$class__sorted__sc_SeqLike__s_math_Ordering__O(this$22, ord));
  var f = (function(d$2) {
    var d = $uI(d$2);
    var jsx$2 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag());
    var jsx$1 = $m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(("" + d), $m_Lscalatags_JsDom$all$().stringAttr$1);
    $m_Lscalatags_JsDom$all$();
    var v = ("" + d);
    return jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$1, new $c_Lscalatags_JsDom$StringFrag().init___T(v)])).render__Lorg_scalajs_dom_raw_Element()
  });
  var this$26 = $m_sci_List$();
  var bf = this$26.ReusableCBFInstance$2;
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    if ((divisors === $m_sci_Nil$())) {
      var jsx$3 = $m_sci_Nil$()
    } else {
      var arg1$1 = divisors.head__O();
      var h = new $c_sci_$colon$colon().init___O__sci_List(f(arg1$1), $m_sci_Nil$());
      var t = h;
      var rest = $as_sci_List(divisors.tail__O());
      while ((rest !== $m_sci_Nil$())) {
    ...
    var b$1 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(divisors, bf);
    var these$1 = divisors;
    while ((!these$1.isEmpty__Z())) {
...
$c_Lwebpage_Minhash$.prototype.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node = (function(target) {
  var this$4 = new $c_sci_Range$Inclusive().init___I__I__I(1, 200, 1);
  var this$5 = $m_sci_List$();
  var cbf = this$5.ReusableCBFInstance$2;
  var seeds = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$4, cbf));
  var box1 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().input__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().type__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().placeholder__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("Enter first string!", $m_Lscalatags_JsDom$all$().stringAttr$1)])).render__Lorg_scalajs_dom_raw_Element();
  var box2 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().input__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().type__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().placeholder__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("Enter second string!", $m_Lscalatags_JsDom$all$().stringAttr$1)])).render__Lorg_scalajs_dom_raw_Element();
  var mhNum = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().input__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().tpe__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("number", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("5", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().min__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("1", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().max__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("200", $m_Lscalatags_JsDom$all$().stringAttr$1)])).render__Lorg_scalajs_dom_raw_Element();
  var bandNum = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().select__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("1", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("1"))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("5", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("5"))]))])).render__Lorg_scalajs_dom_raw_Element();
  var tokenizer = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().select__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("word", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Word"))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("shingle", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Shingle"))]))])).render__Lorg_scalajs_dom_raw_Element();
  $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().select__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("form-control", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().multiple__Lscalatags_generic_AttrPair(), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lowercase", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Lower Case"))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().option__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().value__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("rmpunct", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Remove Punctuation"))]))])).render__Lorg_scalajs_dom_raw_Element();
  var output = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(""))])).render__Lorg_scalajs_dom_raw_Element();
  var tokens = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  var submit = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn btn-primary", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().tpe__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("button", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Submit"))])).render__Lorg_scalajs_dom_raw_Element();
  var minhashBox = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  var bandBox = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  submit.onclick = (function(seeds$1, box1$1, box2$1, mhNum$1, bandNum$1, tokenizer$1, output$1, tokens$1, minhashBox$1, bandBox$1) {
    return (function(e$2) {
      output$1.innerHTML = "";
      var jsx$1 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag());
      $m_Lscalatags_JsDom$all$();
      var v = $m_Lwebpage_Minhash$().webpage$Minhash$$jaccard$1__T__T__Lorg_scalajs_dom_raw_HTMLSelectElement__D($as_T(box1$1.value), $as_T(box2$1.value), tokenizer$1);
      var v$1 = ("" + v);
      output$1.appendChild(jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v$1)])).render__Lorg_scalajs_dom_raw_Element());
      tokens$1.innerHTML = "";
      tokens$1.appendChild($m_Lwebpage_Minhash$().webpage$Minhash$$renderTokens$1__T__T__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLUListElement($as_T(box1$1.value), $as_T(box2$1.value), tokenizer$1));
      minhashBox$1.innerHTML = "";
      minhashBox$1.appendChild($m_Lwebpage_Minhash$().webpage$Minhash$$renderMinhashes$1__T__T__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLDivElement($as_T(box1$1.value), $as_T(box2$1.value), seeds$1, mhNum$1, tokenizer$1));
      bandBox$1.innerHTML = "";
      return bandBox$1.appendChild($m_Lwebpage_Minhash$().webpage$Minhash$$renderBands$1__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLDivElement(seeds$1, box1$1, box2$1, mhNum$1, bandNum$1, tokenizer$1))
    })
  })(seeds, box1, box2, mhNum, bandNum, tokenizer, output, tokens, minhashBox, bandBox);
  mhNum.onchange = (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lwebpage_Minhash$$anonfun$main$2().init___Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement(mhNum, bandNum));
  var jsx$65 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$64 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-center", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$63 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h1__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("display-1", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Minhash"))]));
  var jsx$62 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("lead", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Type here to fiddle with Minhash between two strings!"))]));
  var jsx$61 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().form__Lscalatags_generic_TypedTag());
  var jsx$60 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$59 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$58 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$57 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$56 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$55 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$18 = $m_Lscalatags_JsDom$all$();
  var jsx$54 = jsx$56.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$55, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$18, box1)]));
  var jsx$53 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$52 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$19 = $m_Lscalatags_JsDom$all$();
  var jsx$51 = jsx$60.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$59, jsx$58.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$57, jsx$54, jsx$53.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$52, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$19, box2)]))]))]));
  var jsx$50 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$49 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$48 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$47 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$46 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$45 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Choose your tokenizer"))]))]));
  var jsx$44 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$43 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$21 = $m_Lscalatags_JsDom$all$();
  var jsx$42 = jsx$47.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$46, jsx$45, jsx$44.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$43, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$21, tokenizer)]))]));
  var jsx$41 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$40 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$39 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Choose your number of Minhashes (1-200)"))]))]));
  var jsx$38 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$37 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$23 = $m_Lscalatags_JsDom$all$();
  var jsx$36 = jsx$41.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$40, jsx$39, jsx$38.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$37, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$23, mhNum)]))]));
  var jsx$35 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$34 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$33 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Choose your number of Bands"))]))]));
  var jsx$32 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$31 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$25 = $m_Lscalatags_JsDom$all$();
  var jsx$30 = jsx$50.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$49, jsx$48, jsx$42, jsx$36, jsx$35.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$34, jsx$33, jsx$32.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$31, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$25, bandNum)]))]))]));
  var jsx$29 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var this$26 = $m_Lscalatags_JsDom$all$();
  var jsx$28 = jsx$61.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$51, jsx$30, jsx$29.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$26, submit)]))]));
  var jsx$27 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().hr__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("width:40%", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$26 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$25 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$24 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dl__Lscalatags_generic_TypedTag());
  var jsx$23 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$22 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dt__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Jaccard Similarity: "))]))]));
  var jsx$21 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dd__Lscalatags_generic_TypedTag());
  var jsx$20 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-8", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$28 = $m_Lscalatags_JsDom$all$();
  var jsx$19 = jsx$21.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$20, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$28, output)]));
  var jsx$18 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dt__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Tokens (First 20): "))]))]));
  var jsx$17 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dd__Lscalatags_generic_TypedTag());
  var jsx$16 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-8", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$30 = $m_Lscalatags_JsDom$all$();
  var jsx$15 = jsx$26.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$25, jsx$24.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$23, jsx$22, jsx$19, jsx$18, jsx$17.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$16, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$30, tokens)]))]))]));
  var jsx$14 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().hr__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("width:40%", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$13 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$12 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$11 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$10 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$8 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$7 = $m_Lscalatags_JsDom$all$().style__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("padding-right:20px; border-right: 1px solid #ccc;", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$6 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h4__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Minhashes"))]));
  var this$32 = $m_Lscalatags_JsDom$all$();
  var jsx$5 = jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, jsx$7, jsx$6, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$32, minhashBox)]));
  var jsx$4 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$3 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$2 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h4__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Bands"))]));
  var this$34 = $m_Lscalatags_JsDom$all$();
  return target.appendChild(jsx$65.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$64, jsx$63, jsx$62, jsx$28, jsx$27, jsx$15, jsx$14, jsx$13.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$12, jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$10, jsx$5, jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$3, jsx$2, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$34, bandBox)]))]))]))])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lwebpage_Minhash$.prototype.generateMinhashes$1__p1__T__T__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_List = (function(s1, s2, seeds$1, mhNum$1, tokenizer$1) {
  var x = $as_T(mhNum$1.value);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var this$4 = $m_jl_Integer$();
  var $$this = this$2.repr$1;
  var lim = this$4.parseInt__T__I__I($$this, 10);
  var this$6 = seeds$1.take__I__sci_List(lim);
  var f = (function(tokenizer$1$1, s1$1, s2$1) {
    return (function(s$2) {
      var s = $uI(s$2);
      var t = $m_Lwebpage_Minhash$().webpage$Minhash$$minhash$1__T__I__Lorg_scalajs_dom_raw_HTMLSelectElement__J(s1$1, s, tokenizer$1$1);
      var lo = t.lo$2;
      var hi = t.hi$2;
      var t$1 = $m_Lwebpage_Minhash$().webpage$Minhash$$minhash$1__T__I__Lorg_scalajs_dom_raw_HTMLSelectElement__J(s2$1, s, tokenizer$1$1);
      var lo$1 = t$1.lo$2;
      var hi$1 = t$1.hi$2;
      return new $c_T3().init___O__O__O(new $c_sjsr_RuntimeLong().init___I__I(lo, hi), new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi$1), ((lo === lo$1) && (hi === hi$1)))
    })
  })(tokenizer$1, s1, s2);
  var this$5 = $m_sci_List$();
...
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$renderTokens$1__T__T__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLUListElement = (function(s1, s2, tokenizer$1) {
  var token1 = this.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set($as_T(s1.toLowerCase()), tokenizer$1);
  var token2 = this.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set($as_T(s2.toLowerCase()), tokenizer$1);
  var intersection = $as_sci_Set(token1.intersect__sc_GenSet__O(token2));
  var union = $as_sci_Set(token1.union__sc_GenSet__sc_Set(token2));
  var jsx$2 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().ul__Lscalatags_generic_TypedTag());
  var this$8 = $m_Lscalatags_JsDom$all$();
  var this$3 = $m_sci_List$();
  var cbf = this$3.ReusableCBFInstance$2;
  var this$7 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(union, cbf)).take__I__sci_List(20);
  var f = (function(intersection$1) {
    return (function(t$2) {
      var t = $as_T(t$2);
      return (intersection$1.contains__O__Z(t) ? $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().li__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("list-inline-item list-group-item-success", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(t))])) : $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().li__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("list-inline-item", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(t))])))
    })
  })(intersection);
  ...
  var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
  return jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$8, xs, ev), $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("list-inline", $m_Lscalatags_JsDom$all$().stringAttr$1)])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$jaccard$1__T__T__Lorg_scalajs_dom_raw_HTMLSelectElement__D = (function(s1, s2, tokenizer$1) {
  var token1 = this.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set($as_T(s1.toLowerCase()), tokenizer$1);
  var token2 = this.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set($as_T(s2.toLowerCase()), tokenizer$1);
  return ($as_sc_TraversableOnce(token1.intersect__sc_GenSet__O(token2)).size__I() / token1.union__sc_GenSet__sc_Set(token2).size__I())
});
$c_Lwebpage_Minhash$.prototype.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set = (function(s, tokenizer$1) {
  return $as_sci_Set(this.getTokenizer$1__p1__Lorg_scalajs_dom_raw_HTMLSelectElement__F1(tokenizer$1).apply__O__O(s))
});
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$minhash$1__T__I__Lorg_scalajs_dom_raw_HTMLSelectElement__J = (function(s, seed, tokenizer$1) {
  var this$2 = this.tokenize$1__p1__T__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_Set(s, tokenizer$1);
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(seed$1) {
    return (function(x$2) {
      var x = $as_T(x$2);
      return $m_s_util_hashing_MurmurHash3$().stringHash__T__I__I(x, seed$1)
    })
  })(seed));
  var this$1 = $m_sci_Set$();
  var bf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$1);
  var value = $uI($as_sc_TraversableOnce($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this$2, f, bf)).min__s_math_Ordering__O($m_s_math_Ordering$Int$()));
  var hi = (value >> 31);
  return new $c_sjsr_RuntimeLong().init___I__I(value, hi)
});
$c_Lwebpage_Minhash$.prototype.webpage$Minhash$$renderMinhashes$1__T__T__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__Lorg_scalajs_dom_raw_HTMLDivElement = (function(s1, s2, seeds$1, mhNum$1, tokenizer$1) {
  var x = $as_T(mhNum$1.value);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var this$4 = $m_jl_Integer$();
  var $$this = this$2.repr$1;
  var lim = this$4.parseInt__T__I__I($$this, 10);
  var minhashes = this.generateMinhashes$1__p1__T__T__sci_List__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement__sci_List(s1, s2, seeds$1, mhNum$1, tokenizer$1);
  var elem$1 = 0;
  elem$1 = 0;
  var these = minhashes;
  while ((!these.isEmpty__Z())) {
  ...
  var numTrue = elem$1;
  var jsx$27 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$26 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$25 = $m_Lscalatags_JsDom$all$().fontSize__Lscalatags_generic_Styles$fontSize$().$$colon$eq__O__Lscalatags_generic_StyleValue__Lscalatags_generic_StylePair("12px", $m_Lscalatags_JsDom$all$().stringStyle$1);
  var jsx$24 = ((numTrue > 0) ? $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h6__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Its a 'match'!"))])) : $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h6__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Its not a 'match'!"))])));
  var jsx$23 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag());
  $m_Lscalatags_JsDom$all$();
  var v = ((("There were " + numTrue) + " matching minhashes out of ") + lim);
  var jsx$22 = jsx$23.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_JsDom$StringFrag().init___T(v)]));
  var jsx$21 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dl__Lscalatags_generic_TypedTag());
  var jsx$20 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$19 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dt__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Minhash Collision Rate: "))]))]));
  var jsx$18 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().dd__Lscalatags_generic_TypedTag());
  var jsx$17 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm-8", $m_Lscalatags_JsDom$all$().stringAttr$1);
  $m_Lscalatags_JsDom$all$();
  var v$1 = (numTrue / lim);
  var v$2 = ("" + v$1);
  var jsx$16 = jsx$21.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$20, jsx$19, jsx$18.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$17, new $c_Lscalatags_JsDom$StringFrag().init___T(v$2)]))]));
  var this$17 = $m_Lscalatags_JsDom$all$();
  var f = (function(m$2) {
    var m = $as_T3(m$2);
    if ($uZ(m.$$und3$1)) {
      var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$6 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
      var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$4 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm bg-success text-white", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var t = $uJ(m.$$und1$1);
      var lo = t.lo$2;
      var hi = t.hi$2;
      var v$3 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$toString__I__I__T(lo, hi);
      var jsx$3 = jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, new $c_Lscalatags_JsDom$StringFrag().init___T(v$3)]));
      var jsx$2 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$1 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm bg-success text-white", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var t$1 = $uJ(m.$$und2$1);
      var lo$1 = t$1.lo$2;
      var hi$1 = t$1.hi$2;
      var v$4 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$toString__I__I__T(lo$1, hi$1);
      return jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6, jsx$3, jsx$2.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$1, new $c_Lscalatags_JsDom$StringFrag().init___T(v$4)]))]))
    } else {
      var jsx$14 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$13 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1);
      var jsx$12 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$11 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var t$2 = $uJ(m.$$und1$1);
      var lo$2 = t$2.lo$2;
      var hi$2 = t$2.hi$2;
      var v$5 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$toString__I__I__T(lo$2, hi$2);
      var jsx$10 = jsx$12.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$11, new $c_Lscalatags_JsDom$StringFrag().init___T(v$5)]));
      var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
      var jsx$8 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-sm", $m_Lscalatags_JsDom$all$().stringAttr$1);
      $m_Lscalatags_JsDom$all$();
      var t$3 = $uJ(m.$$und2$1);
      var lo$3 = t$3.lo$2;
      var hi$3 = t$3.hi$2;
      var v$6 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$toString__I__I__T(lo$3, hi$3);
      return jsx$14.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$13, jsx$10, jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, new $c_Lscalatags_JsDom$StringFrag().init___T(v$6)]))]))
    }
  });
  var this$16 = $m_sci_List$();
  ...
  if ((bf === $m_sci_List$().ReusableCBFInstance$2)) {
    ...
    var b = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(minhashes, bf);
    var these$1 = minhashes;
    while ((!these$1.isEmpty__Z())) {
      var arg1$3 = these$1.head__O();
    ...
    var jsx$15 = b.result__O()
  };
  var xs = $as_sc_Seq(jsx$15);
  var ev = $m_s_Predef$().singleton$und$less$colon$less$2;
  return jsx$27.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$26, jsx$25, jsx$24, jsx$22, jsx$16, new $c_Lscalatags_JsDom$Cap$SeqFrag().init___Lscalatags_JsDom$Cap__sc_Seq__F1(this$17, xs, ev)])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lwebpage_Minhash$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O = (function(target) {
  return this.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_Node(target)
});
$c_Lwebpage_Minhash$.prototype.getTokenizer$1__p1__Lorg_scalajs_dom_raw_HTMLSelectElement__F1 = (function(tokenizer$1) {
  var x1 = $as_T(tokenizer$1.value);
  if ((x1 === "word")) {
    return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(s$2) {
      var s = $as_T(s$2);
      var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(s, " ", 0);
      var this$3 = $m_sci_Set$();
      var cbf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$3);
      var b = cbf.apply__scm_Builder();
      b.sizeHint__I__V(xs.u.length);
      b.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_scm_WrappedArray$ofRef().init___AO(xs));
      return $as_sci_Set(b.result__O())
    }))
  } else if ((x1 === "shingle")) {
    return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(s$2$1) {
      var s$1 = $as_T(s$2$1);
      var this$7 = new $c_sci_StringOps().init___T(s$1);
      var this$8 = $s_sc_IterableLike$class__sliding__sc_IterableLike__I__I__sc_Iterator(this$7, 3, 1);
      var this$9 = $m_sci_Set$();
      var cbf$1 = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$9);
      return $as_sci_Set($s_sc_TraversableOnce$class__to__sc_TraversableOnce__scg_CanBuildFrom__O(this$8, cbf$1))
    }))
  } else {
    throw new $c_s_MatchError().init___O(x1)
  }
});
$c_Lwebpage_Minhash$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__O(prep0)
});
var $d_Lwebpage_Minhash$ = new $TypeData().initClass({
  Lwebpage_Minhash$: 0
}, false, "webpage.Minhash$", {
  Lwebpage_Minhash$: 1,
  O: 1
});
$c_Lwebpage_Minhash$.prototype.$classData = $d_Lwebpage_Minhash$;
var $n_Lwebpage_Minhash$ = (void 0);
function $m_Lwebpage_Minhash$() {
  if ((!$n_Lwebpage_Minhash$)) {
    $n_Lwebpage_Minhash$ = new $c_Lwebpage_Minhash$().init___()
  };
  return $n_Lwebpage_Minhash$
}
$e.webpage = ($e.webpage || {});
$e.webpage.Minhash = $m_Lwebpage_Minhash$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
$c_s_util_hashing_MurmurHash3.prototype.stringHash__T__I__I = (function(str, seed) {
  var h = seed;
  var i = 0;
  while ((((1 + i) | 0) < $uI(str.length))) {
    var index = i;
    var jsx$1 = $uI(str.charCodeAt(index));
    var index$1 = ((1 + i) | 0);
    var data = ((((65535 & jsx$1) << 16) + (65535 & $uI(str.charCodeAt(index$1)))) | 0);
  ...
  if ((i < $uI(str.length))) {
    var jsx$2 = h;
    var index$2 = i;
    h = this.mixLast__I__I__I(jsx$2, (65535 & $uI(str.charCodeAt(index$2))))
  };
  return this.finalizeHash__I__I__I(h, $uI(str.length))
});
...
/** @constructor */
function $c_Lwebpage_Minhash$$anonfun$main$2() {
  $c_sr_AbstractFunction1.call(this);
  this.mhNum$1$2 = null;
  this.bandNum$1$f = null
}
$c_Lwebpage_Minhash$$anonfun$main$2.prototype = new $h_sr_AbstractFunction1();
$c_Lwebpage_Minhash$$anonfun$main$2.prototype.constructor = $c_Lwebpage_Minhash$$anonfun$main$2;
/** @constructor */
function $h_Lwebpage_Minhash$$anonfun$main$2() {
  /*<skip>*/
}
$h_Lwebpage_Minhash$$anonfun$main$2.prototype = $c_Lwebpage_Minhash$$anonfun$main$2.prototype;
$c_Lwebpage_Minhash$$anonfun$main$2.prototype.init___Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSelectElement = (function(mhNum$1, bandNum$1) {
  this.mhNum$1$2 = mhNum$1;
  this.bandNum$1$f = bandNum$1;
  return this
});
$c_Lwebpage_Minhash$$anonfun$main$2.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_scalajs_dom_raw_Event__sci_List(v1)
});
$c_Lwebpage_Minhash$$anonfun$main$2.prototype.apply__Lorg_scalajs_dom_raw_Event__sci_List = (function(e) {
  this.bandNum$1$f.innerHTML = "";
  var this$2 = $m_Lwebpage_Minhash$().webpage$Minhash$$renderBandOptions$1__Lorg_scalajs_dom_raw_HTMLInputElement__sci_List(this.mhNum$1$2);
  var f = (function(arg$outer) {
    return (function(i$2) {
      return arg$outer.bandNum$1$f.appendChild(i$2)
    })
  })(this);
  var this$1 = $m_sci_List$();
...
var $d_Lwebpage_Minhash$$anonfun$main$2 = new $TypeData().initClass({
  Lwebpage_Minhash$$anonfun$main$2: 0
}, false, "webpage.Minhash$$anonfun$main$2", {
  Lwebpage_Minhash$$anonfun$main$2: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lwebpage_Minhash$$anonfun$main$2.prototype.$classData = $d_Lwebpage_Minhash$$anonfun$main$2;
/** @constructor */
...
$c_sc_Iterator$$anon$19.prototype.init___sc_Iterator__sc_Iterator = (function($$outer, that$3) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_sc_Iterator$$anon$19.prototype.next__T2 = (function() {
  return new $c_T2().init___O__O(this.$$outer$2.next__O(), this.that$3$2.next__O())
});
...
$c_sc_Iterator$GroupedIterator.prototype.gap__p2__I = (function() {
  var x = ((this.step$2 - this.size$2) | 0);
  return ((x > 0) ? x : 0)
});
    ...
    if (this.$$undpartial$2) {
      ...
      if (jsx$2) {
        if ((!this.isFirst$1__p2__I__Z(prevSize))) {
          ...
          var x$1 = this.step$2;
          var n = ((x$1 < prevSize) ? x$1 : prevSize);
        ...
        if (this.isFirst$1__p2__I__Z(prevSize)) {
          ...
          if (jsx$7) {
            if ((!this.isFirst$1__p2__I__Z(prevSize))) {
              ...
              var x$2 = this.step$2;
              var n$1 = ((x$2 < prevSize) ? x$2 : prevSize);
          ...
          var howMany$2 = ((x$3 < that$3) ? x$3 : that$3);
          if ((howMany$2 > 0)) {
            if (this.isFirst$1__p2__I__Z(prevSize)) {
              var jsx$10 = true
            } else {
          ...
          if (jsx$10) {
            if ((!this.isFirst$1__p2__I__Z(prevSize))) {
              ...
              var x$4 = this.step$2;
              var n$2 = ((x$4 < prevSize) ? x$4 : prevSize);
...
/** @constructor */
function $c_Lscalatags_generic_Styles$fontSize$() {
...
$c_Lscalatags_generic_Styles$fontSize$.prototype = new $h_Lscalatags_generic_Style();
...
$c_Lscalatags_generic_Styles$fontSize$.prototype.init___Lscalatags_generic_Styles = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
  };
  $c_Lscalatags_generic_Style.prototype.init___T__T.call(this, "fontSize", "font-size");
  return this
});
...
$c_Lscalatags_JsDom$all$.prototype.max__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var lo = (32 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$all$.prototype.tpe__Lscalatags_generic_Attr = (function() {
  ...
  if ((lo === 0)) {
    return this.tpe$lzycompute__p1__Lscalatags_generic_Attr()
  } else {
    return this.tpe$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.min__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var lo = (64 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$all$.prototype.tpe$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var lo = (524288 & b.lo$2);
  if ((lo === 0)) {
    this.tpe$1 = this.type__Lscalatags_generic_Attr();
    var b$1 = this.bitmap$4$1;
...
$c_Lscalatags_JsDom$all$.prototype.max$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var lo = (32 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$all$.prototype.multiple__Lscalatags_generic_AttrPair = (function() {
  var b = this.bitmap$4$1;
  var lo = (128 & b.lo$2);
  if ((lo === 0)) {
    return this.multiple$lzycompute__p1__Lscalatags_generic_AttrPair()
  } else {
...
$c_Lscalatags_JsDom$all$.prototype.fontSize$lzycompute__p1__Lscalatags_generic_Styles$fontSize$ = (function() {
  if ((this.fontSize$module$1 === null)) {
    this.fontSize$module$1 = new $c_Lscalatags_generic_Styles$fontSize$().init___Lscalatags_generic_Styles(this)
  };
...
$c_Lscalatags_JsDom$all$.prototype.h6$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.h6$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "h6", false, ns);
    var b$1 = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$all$.prototype.dd$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (16777216 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.dd$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "dd", false, ns);
    var b$1 = this.bitmap$0$1;
    var lo$1 = (16777216 | b$1.lo$2);
    var hi = b$1.hi$2;
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi)
...
$c_Lscalatags_JsDom$all$.prototype.dl$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (4194304 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.dl$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "dl", false, ns);
    var b$1 = this.bitmap$0$1;
...
$c_Lscalatags_JsDom$all$.prototype.dt$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (8388608 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.dt$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "dt", false, ns);
    var b$1 = this.bitmap$0$1;
    var lo$1 = (8388608 | b$1.lo$2);
    var hi = b$1.hi$2;
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi)
...
$c_Lscalatags_JsDom$all$.prototype.dt__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (8388608 & b.lo$2);
  if ((lo === 0)) {
    return this.dt$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
    return this.dt$1
  }
});
$c_Lscalatags_JsDom$all$.prototype.min$lzycompute__p1__Lscalatags_generic_Attr = (function() {
  var b = this.bitmap$4$1;
  var lo = (64 & b.lo$2);
  if ((lo === 0)) {
...
$c_Lscalatags_JsDom$all$.prototype.dl__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (4194304 & b.lo$2);
  if ((lo === 0)) {
    return this.dl$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
    return this.dl$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.h6__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (4096 & b.lo$2);
  if ((lo === 0)) {
    return this.h6$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
    return this.h6$1
  }
});
$c_Lscalatags_JsDom$all$.prototype.multiple$lzycompute__p1__Lscalatags_generic_AttrPair = (function() {
  var b = this.bitmap$4$1;
  var lo = (128 & b.lo$2);
  if ((lo === 0)) {
    this.multiple$1 = $s_Lscalatags_generic_InputAttrs$class__multiple__Lscalatags_generic_InputAttrs__Lscalatags_generic_AttrPair(this);
    var b$1 = this.bitmap$4$1;
    var lo$1 = (128 | b$1.lo$2);
    var hi = b$1.hi$2;
    this.bitmap$4$1 = new $c_sjsr_RuntimeLong().init___I__I(lo$1, hi)
...
$c_Lscalatags_JsDom$all$.prototype.dd__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var lo = (16777216 & b.lo$2);
  if ((lo === 0)) {
    return this.dd$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
    return this.dd$1
  }
});
...
$c_sc_AbstractSet.prototype.intersect__sc_GenSet__O = (function(that) {
  return this.filter__F1__O(that)
});
...
$c_sci_HashSet.prototype.intersect__sc_GenSet__sci_HashSet = (function(that) {
  if ($is_sci_HashSet(that)) {
    var x2 = $as_sci_HashSet(that);
    var x = this.size__I();
    var that$1 = x2.size__I();
    var size = ((x < that$1) ? x : that$1);
    var x$1 = ((6 + size) | 0);
    var buffer = $newArrayObject($d_sci_HashSet.getArrayOf(), [((x$1 < 224) ? x$1 : 224)]);
    var s = this.intersect0__sci_HashSet__I__Asci_HashSet__I__sci_HashSet(x2, 0, buffer, 0);
    return ((s === null) ? $m_sci_HashSet$EmptyHashSet$() : s)
  } else {
    return this.filter__F1__sci_HashSet(that)
  }
});
...
$c_sci_HashSet$HashTrieSet.prototype.intersect0__sci_HashSet__I__Asci_HashSet__I__sci_HashSet = (function(that, level, buffer, offset0) {
  if ((that === this)) {
    ...
    while (((abm & bbm) !== 0)) {
      ...
      var blsb = (bbm ^ (bbm & (((-1) + bbm) | 0)));
      if ((alsb === blsb)) {
        var sub1 = a.u[ai].intersect0__sci_HashSet__I__Asci_HashSet__I__sci_HashSet(b.u[bi], ((5 + level) | 0), buffer, offset);
        if ((sub1 !== null)) {
          rs = ((rs + sub1.size__I()) | 0);
          rbm = (rbm | alsb);
          buffer.u[offset] = sub1;
...
$c_sci_HashSet$HashSet1.prototype.intersect0__sci_HashSet__I__Asci_HashSet__I__sci_HashSet = (function(that, level, buffer, offset0) {
  return (that.get0__O__I__I__Z(this.key$6, this.hash$6, level) ? this : null)
});
...
$c_sci_HashSet$HashSetCollision1.prototype.intersect0__sci_HashSet__I__Asci_HashSet__I__sci_HashSet = (function(that, level, buffer, offset0) {
  ...
  var x1 = ks1.size__I();
  return ((x1 === 0) ? null : ((x1 === this.ks$6.size__I()) ? this : ((x1 === that.size__I()) ? that : ((x1 === 1) ? new $c_sci_HashSet$HashSet1().init___O__I(ks1.head__O(), this.hash$6) : new $c_sci_HashSet$HashSetCollision1().init___I__sci_ListSet(this.hash$6, ks1)))))
});
...
$c_sci_Range.prototype.takeRight__I__sci_Range = (function(n) {
  if ((n <= 0)) {
    ...
    var value$2 = (((-1) + n) | 0);
    var hi$2 = (value$2 >> 31);
    var lo = $imul(value$1, value$2);
    var hi$3 = $m_sjsr_RuntimeLong$().scala$scalajs$runtime$RuntimeLong$$timesHi__I__I__I__I__I(value$1, hi$1, value$2, hi$2);
    var lo$1 = ((y - lo) | 0);
    var hi$4 = ((((-2147483648) ^ lo$1) > ((-2147483648) ^ y)) ? (((-1) + ((hi - hi$3) | 0)) | 0) : ((hi - hi$3) | 0));
    if ((this.step$4 > 0)) {
      var value$3 = this.start$4;
      var hi$5 = (value$3 >> 31);
      var jsx$2 = ((hi$4 === hi$5) ? (((-2147483648) ^ lo$1) < ((-2147483648) ^ value$3)) : (hi$4 < hi$5))
    } else {
      var jsx$2 = false
    };
    if (jsx$2) {
      ...
      var hi$6 = (value$4 >> 31);
      var jsx$1 = ((hi$4 === hi$6) ? (((-2147483648) ^ lo$1) > ((-2147483648) ^ value$4)) : (hi$4 > hi$6))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
      ...
      return new $c_sci_Range$Inclusive().init___I__I__I(lo$1, y, this.step$4)
    }
  }
});
...
//# sourceMappingURL=minhashplayground-fastopt.js.map
